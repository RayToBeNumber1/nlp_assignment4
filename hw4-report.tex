...
\begin{itemize}
    \item \textbf{GitHub Repository:} \url{https://github.com/RayToBeNumber1/nlp_assignment4}
...
\section{AI USE}
Using Claude AI to help me understand the question and write some of the code in part1 and part2, also use AI to assistant me summarize the writeup.
